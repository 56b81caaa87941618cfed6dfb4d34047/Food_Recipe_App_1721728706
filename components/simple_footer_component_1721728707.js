...
*/
Vue.component("simple_footer_component_1721728707", {
    template: `
            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Craft your culinary creations with ease using FoodBuilder. Our innovative app lets you design and visualize recipes, plan meals, and discover new flavor combinations. Built for food lovers by food lovers.
                    </div>
                </div>
            </div>
        </footer> 
